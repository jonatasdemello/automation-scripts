...
Get-ChildItem -path .\ -Include node_modules -Recurse | foreach ($_) { remove-item -Path $_.fullname -Recurse -Force -ErrorAction SilentlyContinue}

# remove all .git folders:
Get-ChildItem -path ".git" -Directory -Recurse -Hidden -Force | foreach ($_) { remove-item -Path $_.fullname -Recurse -Force -ErrorAction SilentlyContinue}


#Get-ChildItem -path .\ -Directory -Recurse -Force | Remove-Item -force -Recurse -ErrorAction SilentlyContinue -verbose
