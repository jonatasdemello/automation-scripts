...
Remove-Item -Path $windowsTemp -Recurse -force

Remove-Item -Path $tempFiles -Recurse -force
...
# ou can also run this command to open file explorer:
ii "C:\path\to\dir"
